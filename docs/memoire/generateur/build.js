...
add(H1("15. Validation"),
  ...
  P("**Premier essai Simulink (MATLAB R2025b, scénario 1)** : le modèle Stateflow reproduit la même séquence que le firmware (MODE_H2 à 10 s, allumage à 100 % à 130 s, 67 % à 222 s, 33 % à 335 s, veille à 597 s, rallumage à 33 % à 1189 s…), avec des écarts inférieurs à 1 s pendant les vingt premières minutes. Un écart d'environ 4 s s'accumule ensuite à chaque cycle de veille (14 s après une heure) : le firmware lit la sonde T_sec une fois par seconde avec une conversion asynchrone du DS18B20, alors que Simulink la lit tous les 0,1 s. Ce retard de mesure fait légèrement dépasser le seuil de coupure, et la veille dure un peu plus longtemps. La séquence des états reste identique."),
