...
add(H1("14. Modèle Simulink / Stateflow et guide de simulation"),
  ...
  P("Dans le modèle fourni, les ports du sous-système FSM n'étaient reliés ni au chart ni aux sorties : le chart ne recevait aucune entrée et aucune vanne ne pouvait s'ouvrir. Le script `preparer_simulation.m` construit donc un modèle de simulation complet, **sans modifier le modèle d'origine**. Dans MATLAB, dossier `matlab/` :"),
  ...N([
    "`preparer_simulation` : copie `Commande_Sechoir_Hybride_corrige.slx` en `Simulation_Sechoir_Hybride.slx`, complète le chart (`completer_fsm_sechoir`), câble ses 24 entrées, ajoute le brûleur, le séchage, l'apport solaire, les scénarios et l'enregistrement, règle le solveur, puis compile le modèle.",
  ...
  H2("14.3 Réglages faits par preparer_simulation"),
